            ...
            <div class="card-body">
                <form action="{{ route('elections.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="election_name" name="election_name" aria-describedby="election_name_help" placeholder="Enter Election Name">
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" class="form-control" id="election_start_at" name="election_start_at" placeholder="Start date">
                    </div>
                    <div class="form-group">
                        <label for="faculty">End At</label>
                        <input type="datetime-local" name="election_end_at" id="election_end_at" class="form-control" placeholder="End Date">
                    </div>
