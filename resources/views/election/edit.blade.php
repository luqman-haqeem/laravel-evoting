                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7 col-lg-6 pb-2">
                                ...
                                <input type="text"
                                    ...
                                    name="date_range" id="date_range" value="07/01/2023 - 07/27/2023" />
                                @error('date_range')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-sm mb-3 " style=" width: 100px;">
                                            ...
                                            <input type="text"
                                                ...
                                                name="{{ strtoupper($section->name) }}" value="{{$section->max_votes}}" min="1"
                                                max="100">
        ...
        @push('scripts')
            <script>
                $(function() {
                    ...
                    let existingStartDate = moment("{{ $data['election']->start_at }}").format("DD MMM YYYY hh:mm A")
                    let existingEndDate = moment("{{ $data['election']->end_at }}").format("DD MMM YYYY hh:mm A")
                    
                     $('#date_range').daterangepicker({
                        timePicker: true,
                        minDate: moment().startOf('day'),

                        startDate: existingStartDate ?? moment().startOf('hour'),
                        endDate: existingEndDate  ?? moment().startOf('hour').add(24, 'hour'),
                        locale: {
